        ...
        const buttonContent = (
            <button
                ...
                className={`flex items-center ${
                    iconOnly ? "gap-0 p-2" : "gap-1.5 px-2 py-1"
        ...
        <Dialog open={isOpen} onOpenChange={(open) => !open && onCancel()}>
            <DialogContent className="sm:max-w-md" showCloseButton={false}>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        This will create a new conversation branch from this
                        point. You can continue the conversation from here in a
                        separate thread.
                    </DialogDescription>
                </DialogHeader>
                <DialogFooter className="gap-2">
                    ...
                    <Button onClick={onConfirm} disabled={isBranching}>
                        {isBranching ? (
                            <>
                                <svg
...
export const BranchOutButton = React.memo(
    ({
        ...
        }, [messages, chatId, selectedModel, messageIndex]);
        ...
        let buttonContent = (
            <button
                ...
                className={`flex items-center ${
                    iconOnly ? "gap-0 p-2" : "gap-1.5 px-2 py-1"
                } text-sm rounded transition-colors cursor-pointer text-text-muted-light dark:text-text-muted-dark hover:bg-gray-light dark:hover:bg-gray-darker hover:text-text-light dark:hover:text-text-dark disabled:opacity-50 disabled:cursor-not-allowed`}
